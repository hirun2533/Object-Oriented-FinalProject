...
public class RectangleState implements IShape {
	...
	Point BeginPoint;
	Point StopPoint;
	public RectangleState(IShape shape)
	...
	public void selectLine() {
		...
		shape.getShapeSetUp().BeginPoint.getX();
		shape.getShapeSetUp().BeginPoint.getY();
		...
		graphic.drawRect(shapeX, shapeY, width, height);
