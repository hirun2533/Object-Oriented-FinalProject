...
public class BuildUngroupShape implements RunCommand,IUndoRedo {
	...
	public BuildUngroupShape(ShapeSetting shapesetUp)
	{
	...
	{		
		...
		for (IShape Selectshape : shapesetUp.shapeList.getListShape())
				...
				
			{
		 		...
		 		shapesetUp.shapeList.ShapeSelectRemove(Selectshape);
